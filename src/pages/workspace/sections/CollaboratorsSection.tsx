  ...
  return (
    <>
      ...
      {isCollaboratorCreateModalOpen &&
        createPortal(
          <ProfileModal
            isOpen={isCollaboratorCreateModalOpen}
            onClose={() => setIsCollaboratorCreateModalOpen(false)}
            icon={<GroupIcon />}
            title="Novo Colaborador"
            subtitle="Crie um novo colaborador"
            mode="view"
          >
      ...
      {isCollaboratorEditModalOpen &&
        createPortal(
          <ProfileModal
            isOpen={isCollaboratorEditModalOpen}
            onClose={() => setIsCollaboratorEditModalOpen(false)}
            icon={<GroupIcon />}
      ...
      {isCollaboratorViewModalOpen &&
        ...
        createPortal(
          <ProfileModal
            isOpen={isCollaboratorViewModalOpen}
            onClose={() => setIsCollaboratorViewModalOpen(false)}
            icon={<GroupIcon />}
            title="Detalhes do Colaborador"
            subtitle="Visualize as informações do colaborador"
            mode="view"
            headerActions={
              <button
                type="button"
